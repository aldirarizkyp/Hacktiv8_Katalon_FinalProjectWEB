...
WebUI.setText(findTestObject('Register/Page_Register/input_Password'), 'alalal')

WebUI.setText(findTestObject('Register/Page_Register/input_Confirm Password'), 'alalal')
...
WebUI.verifyElementPresent(findTestObject('Register/Page_Register/txt_Your Password must contain at least 8 characters'), 
    0)
